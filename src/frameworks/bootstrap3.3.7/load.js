(function() {
    ...
    $('body').one('wfb-ready', function(e, service) {
        ...
        f.setScriptFileByScriptTagId('plugin-bootstrap-3-3-7', "frameworks/bootstrap3.3.7/load.js"); //get url if script is included directly into edit.html

        service.addFramework(f, 3);
        ...
        var getPlaceholderImage = function() {
            return service.getPlaceholderImage();
        }
		...
		*/
        ...
        var db_boolean = {
            ...
            'drag_helper': '<div class="radio" style="width: 120px">\
                        <label class="control-label">\
                            <input type="radio" name="boolean" value="yes" checked>\
                                Yes\
                        </label>\
        ...
        var db_input_str = {
            ...
            'code' : '<input type="text" class="form-control" placeholder="abc">',
            'drag_helper' : '<input type="text" class="form-control" placeholder="abc" style="width: 92px; height: 47px;">',
            'name' : 'Input',
            'sections' : crsaAddStandardSections({
                'data' : {
                    name : 'Input options',
        ...
        var db_input_num = {
            ...
            'code' : '<input type="number" class="form-control" placeholder="123">',
            'drag_helper' : '<input type="number" class="form-control" placeholder="123" style="width: 92px; height: 47px;">',
            'name' : 'Input',
            'sections' : crsaAddStandardSections({
                'data' : {
                    name : 'Input options',
        ...
        var db_input_cur = {
            ...
            'code' : '<input type="text" class="form-control" placeholder="$123">',
            'drag_helper' : '<input type="text" class="form-control" placeholder="$123" style="width: 92px; height: 47px;">',
            'name' : 'Input',
            'sections' : crsaAddStandardSections({
                'data' : {
                    name : 'Input options',
        ...
        var db_input_date = {
            ...
            'code' : '<input type="date" class="form-control" placeholder="">',
            'drag_helper' : '<input type="date" class="form-control" placeholder="" style="width: 180px; height: 30px;">',
            'name' : 'Input',
            'sections' : crsaAddStandardSections({
                'data' : {
                    name : 'Input options',
        ...
        f.addComponentType(db_input_str);
        f.addComponentType(db_input_num);
        ...
        var db_select = {
            ...
            'drag_helper' : '<select class="form-control" style="width: 92px; height: 47px;">\
                        <option>1</option>\
                        <option>2</option>\
                        <option>3</option>\
                    </select>',
        ...
        f.addTemplateProjectFromResourceFolder('templates', null, 0, function (node) {
