...
(function() {
    ...
    $('body').one('wfb-ready', function(e, service) {
        ...
        service.addFramework(f, 100); //show at the bottom
            ...
            {'name' : 'External content', key: 'html-embed', els: [
                {
                    tag: 'img/e',
                    code : function() {
                        return '<img src="' + service.getPlaceholderImage() + '"/>';
                    },
                    props: {
                ...
                'html.page' : {
                    ...
                    fields: {
                        'page.title' : {
                            ...
                            options : function() {
                                return service.insight.getContentsForTag('title');
                            },
                            get_value: function(obj) {
                            ...
                            set_value: function(obj, value, values, oldValue, eventType) {
                                ...
                                pgel.html(value);
                                if(eventType == 'change') service.updateTree(get$Head(obj.data));
                                return value;
                            }
                        },
                        'page.description' : {
                            ...
                            options : function() {
                                return service.insight.getMetaValuesForName('description');
                            },
                            get_value: function(obj) {
                        ...
                        'page.keywords' : {
                            ...
                            'options' : function() {
                                return service.insight.getKeywords();
                            },
                            get_value: function(obj) {
                        ...
                        'page.author' : {
                            ...
                            options : function() {
                                return service.insight.getMetaValuesForName('author');
                            },
                            get_value: function(obj) {
